...
SECRET_KEY = '@@7yh)p3n&=!*#^pfs%hlms!djxn&w)y2sy3^ernx%mxhn*-7k'
...
#Los dirs sirven para crear un directorio general donde almacenemos todos los archivos
#donde podemos reutilizar codigo
#
TEMPLATES = [
    {
